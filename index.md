...
|:---|---:|---:|---:|---:|
| [March 2026 flat](https://rgenomicsetl.github.io/RClinVarbitration/inst/benchmarks/full-flat-release-2026-03.dcf) | 38,596,056 | 4.98 GiB | 4,410,536 / 4,389,459 | 4,463,601 / 4,389,810 |
| [2 July 2026 XML](https://rgenomicsetl.github.io/RClinVarbitration/inst/benchmarks/full-release-2026-07-02.dcf) | 109,372,736 | 8.73 GiB | 4,465,523 / 4,444,013 | 4,518,795 / 4,444,344 |
...
only when the analysis needs XML-only observations, citations,
attributable text, or disease-scoped assertion structure. The XML path
writes the same scalar `clinvar` table as the flat import. Compatibility
